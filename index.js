...
//   params: {
//     folder: "audio_uploads", // optional folder name
...
//     // Save temp file
//     const tempInput = path.join(__dirname, "temp_input_" + Date.now() + path.extname(req.file.originalname));
...
// //     // Whisper API expects multipart/form-data with proper file type
// //     const form = new FormData();
